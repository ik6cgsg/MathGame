        ...
        while (currentRightIndex < chain.size) {
            ...
            if (chain[currentRightIndex].type() == ComparableTransformationPartType.RULE ||
                ...
                if (chain[currentRightIndex].type() == ComparableTransformationPartType.RULE) {
                    ...
                    val checkingResult = rule.check(factComporator, false, factsTransformations, expressionTransformations, additionalFacts, skipTrivialCheck)
...
//        }
    ...
    override fun check(factComporator: FactComporator, onExpressionLevel: Boolean,
        ...
        for (factChain in factTransformationChains) {
            val checkingResult = factChain.chain.first().check(factComporator, false, factsTransformations, expressionTransformations, additionalFacts, skipTrivialCheck)
