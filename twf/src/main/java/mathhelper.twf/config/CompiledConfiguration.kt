...
import mathhelper.twf.factstransformations.FactComporator
...
class CompiledConfiguration(
    ...
    fun createExpressionFunctionNode (function: String, numberOfArgs: Int, children: List<ExpressionNode> = listOf())
            = ExpressionNode(NodeType.FUNCTION, function, functionStringDefinition = functionConfiguration.fastFindStringDefinitionByNameAndNumberOfArguments(function, numberOfArgs)).apply {
